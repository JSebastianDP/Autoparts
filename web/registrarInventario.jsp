                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <section class="form-register">
                                        <form method="POST" action="Inventario" class="login">  
                                            <h3>Registrar Inventario</h3><br>
                                            <table>
                                                <tr>
                                                    Informacion<br>
                                                <input class="controls" type="text" name="textInformacion" required>
                                                <br><br>
                                                Perdidas<br>
                                                <input class="controls" type="nume" name="textPerdidas" required>
                                                <br><br>
                                                Producto<br>
                                                <input class="controls" type="text" name="textProducto" required>
                                                <br><br>
                                                <input class="controls" type="hidden"  value="${PersonaVO.id}" name="textEmpleado" required>
                                                <br><br>
                                                </tr>
                                            </table><br>
