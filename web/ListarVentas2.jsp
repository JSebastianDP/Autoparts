        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="Listar?variable=ListarVentas2"> <i class='bx bx-file-find'></i> Consulta ventas </a>
                        ...
                        <div class="box-body">
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaVentas" class="display">
                                    ...
                                    <c:forEach var="que" items="${ven}" varStatus="iteracion">                                                    
                                        <tr>
                                            <td>${que.getId()}</td>
                                            ...
                                            <td><a class="btn btn-warning" href="#">Editar</a>
                                                <c:if test="${c.getEstado_compra() eq 'Pendiente'}" >

                                                    <input type="hidden" name="id" value="${c.getId()}">
                                                    <button class="btn-transparetn border-0 bg-transparent py-2"
                                                            onclick="alertaInactivarC(${c.getId()}, 'Pendiente')">
                                                        <i class="fas fa-truck-loading" style="font-size:25px;"></i></button>


                                                </c:if>
                                                <c:if test="${c.getEstado_compra() eq 'Entregado'}" >

                                                    <input type="hidden" name="id" value="${c.getId()}">
                                                    <button class="btn-transparetn border-0 bg-transparent py-2"
                                                            onclick="alertaActivarC(${c.getId()}, 'Entregado')">
